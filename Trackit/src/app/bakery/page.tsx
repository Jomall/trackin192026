...
export default function Bakery() {
  ...
  const [newItem, setNewItem] = useState({ name: '', type: 'machinery', description: '', quantity: 0 })

  useEffect(() => {
    // TODO: Fetch items from API
    setItems([
      { id: 1, name: 'Oven', type: 'machinery', description: 'Industrial baking oven', quantity: 2 },
      { id: 2, name: 'Mixer', type: 'equipment', description: 'Dough mixer', quantity: 3 },
    ])
  }, [])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setItems([...items, item])
    setNewItem({ name: '', type: 'machinery', description: '', quantity: 0 })
  }
